...
define('dummy/tests/routes/application.jshint.lint-test', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/application.js should pass jshint.\nroutes/application.js: line 37, col 16, \'x\' is defined but never used.\nroutes/application.js: line 24, col 9, \'params\' is defined but never used.\nroutes/application.js: line 69, col 31, \'model\' is defined but never used.\n\n3 errors');
  });
});
